...
const routes = [
  ...
  },
  {
    ...
    //pour des raisons de performances, on va importer les composants ici plutôt qu'en haut de page, ainsi, ils sont chargés en différés par rapport à la page home
  },
  {
    path: "/login",
    name: "Login",
